...
#         .create(
#         body="Etot mesaj prishol samoi bolshoi jope no i samoi krasiwoi umnoi i interesnoi, tak shto vam oceni povezlo ca poluchaete acest mesaj pupsik❤️❤️❤️",
#         from_='+12028662785',
#         to='+400732008413'
#     )
#     print(message.sid)
...
message = client.messages \
        .create(
        body="Etot mesaj prishol samoi bolshoi jope no i samoi krasiwoi umnoi i interesnoi, tak shto vam oceni povezlo ca poluchaete acest mesaj pupsik❤️❤️❤️. TE IUBESCCC și da pofta buna inca odata!!!",
        from_='+12028662785',
        to='+373079143702'
)
print(message.sid)
